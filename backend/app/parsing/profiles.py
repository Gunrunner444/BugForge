...
CSHARP = LanguageProfile(
    ...
    import_patterns=(r"using\s+([A-Za-z0-9_.]+)",),
    function_patterns=(
        r"(?:public|private|protected|internal|static|async|\s)+\s+[\w<>\[\]]+\s+([A-Za-z_][\w]*)\s*\(",
    ),
    class_patterns=(r"\b(?:class|interface|struct|record)\s+([A-Za-z_][\w]*)",),
    assignment_patterns=(r"(?:var|[A-Za-z_][\w<>,\[\]]*)\s+([A-Za-z_][\w]*)\s*=\s*(.+)$",),
    source_patterns=(
        r"Request\.Query",
        r"Request\.Form",
    ...
    sql_sinks=(r"ExecuteReader", r"ExecuteNonQuery", r"SqlCommand", r"FromSqlRaw"),
    command_sinks=(r"Process\.Start", r"ProcessStartInfo"),
    path_sinks=(r"File\.Open", r"File\.ReadAllText", r"FileStream"),
    ssrf_sinks=(r"HttpClient", r"WebRequest"),
    xss_sinks=(r"Html\.Raw",),
    deser_sinks=(r"BinaryFormatter", r"SoapFormatter"),
    eval_sinks=(r"CompileAssemblyFromSource",),
    redirect_sinks=(r"Redirect\s*\(", r"LocalRedirect"),
    crypto_patterns=_COMMON_CRYPTO,
...
SHELL = LanguageProfile(
    ...
    function_patterns=(r"^\s*(?:function\s+)?([A-Za-z_][\w]*)\s*\(\)",),
    class_patterns=(),
    assignment_patterns=(r"^([A-Za-z_][\w]*)=",),
    source_patterns=(r"\$1", r"\$@", r"\$\{"),
    sql_sinks=(),
    command_sinks=(r"\beval\b", r"\bbash\b", r"\bsh\b"),
    path_sinks=(r"\bcat\b", r"\brm\b", r"\bsource\b"),
    ssrf_sinks=(r"\bcurl\b", r"\bwget\b"),
    xss_sinks=(),
    deser_sinks=(),
    eval_sinks=(r"\beval\b",),
    redirect_sinks=(),
    crypto_patterns=(),
...
HTML = LanguageProfile(
    ...
    line_comment=None,
    block_comment=("<!--", "-->"),
    import_patterns=(r"""<(?:script|link)\s+[^>]*(?:src|href)=['\"]([^'\"]+)""",),
    function_patterns=(),
    class_patterns=(),
    assignment_patterns=(),
    source_patterns=(),
    ...
    path_sinks=(),
    ssrf_sinks=(),
    xss_sinks=(r"onerror=", r"onload=", r"javascript:", r"<script"),
    deser_sinks=(),
    eval_sinks=(),
    redirect_sinks=(),
    crypto_patterns=(),
...
CSS = LanguageProfile(
    ...
    path_sinks=(),
    ssrf_sinks=(),
    xss_sinks=(r"expression\s*\(", r"javascript:"),
    deser_sinks=(),
    eval_sinks=(),
    redirect_sinks=(),
    crypto_patterns=(),
...
SCSS = LanguageProfile(
    language_id="scss",
    display_name="SCSS",
    extensions=frozenset({".scss", ".sass"}),
    line_comment="//",
    block_comment=("/*", "*/"),
    import_patterns=CSS.import_patterns,
    function_patterns=(),
    class_patterns=(),
    assignment_patterns=(),
    source_patterns=(),
    ...
    path_sinks=(),
    ssrf_sinks=(),
    xss_sinks=CSS.xss_sinks,
    deser_sinks=(),
    eval_sinks=(),
    redirect_sinks=(),
    crypto_patterns=(),
    tree_sitter_language="scss",
)
...
SQL = LanguageProfile(
    ...
    assignment_patterns=(),
    source_patterns=(),
    sql_sinks=(r"\bEXECUTE\b", r"\bEXEC\b", r"\bDROP\b"),
    command_sinks=(),
    path_sinks=(),
    ssrf_sinks=(),
    xss_sinks=(),
