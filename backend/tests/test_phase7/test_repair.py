...
class TestRepairScoring:
    ...
    def test_bug_not_fixed_no_regressions(self) -> None:
        from app.services.repair_service import RepairService
    ...
    def test_unknown_bug_status_no_regressions(self) -> None:
        from app.services.repair_service import RepairService
    ...
    def test_many_regressions_capped_at_zero(self) -> None:
        from app.services.repair_service import RepairService
...
class TestReproductionClassificationFixed:
    ...
    def test_exit_code_1_no_pattern_is_no_evidence(self) -> None:
        ...
        cls, reproduced, _evidence = _classify_attempt(FakeResult(), expected_failure_pattern=None)
        assert cls == "no_evidence"
        assert reproduced is False
